...
// #define _TEST_PAGE_TABLE_
    ...
    VMPool heap_pool_1(1 GB, 256 MB, &process_mem_pool, &pt1);
    VMPool heap_pool_2(1 GB, 256 MB, &process_mem_pool, &pt1);
    ...
    GenerateVMPoolMemoryReferences(&heap_pool_1, 50, 100);
