...
/* This macro is defined when we want to force the code below to use the
   round-robin scheduler. It is used with macro _USES_SCHEDULER_
   If macro _USES_SCHEDULER_ is not defined with macro _RR_SCHEDULER_,
